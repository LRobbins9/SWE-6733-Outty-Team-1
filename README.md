...
## Team 1 Members 
Angel Arnold - Scrum Master  
Lauren Robbins - Product Owner   
Jeffrey McGurk - Developer  
Kennedy Hemphill - Developer  
Ricardo Hernandez - Developer  
...
- UI color scheming
- Matching Algorithm
- BDD Test Suite with Unit Tests (currently have 83 unit tests)
- Photo upload
- In-app messaging
